class VotosMunColumnsSelector:
    ...
    def columns(self):
        return self.columns_list[self.reg]

    def visible_columns(self):
        if self.reg == 9:
            return ["ANO_ELEICAO", "NUM_TURNO", "DESCRICAO_ELEICAO", "UF", "SIGLA_UE", "COD_MUN_TSE", "NUM_ZONA",
        ...
        columns += ["SIGLA_UE", "NUMERO_CANDIDATO", "NUM_TURNO", "DESCRICAO_CARGO", "QTDE_VOTOS"]
    ...
    def order_by_columns(self):
        if self.reg == 9:
            return ["ANO_ELEICAO", "UF", "SIGLA_UE", "CODIGO_CARGO", "NUMERO_CANDIDATO"]
        else:
